...
- combining bdj02-03-04 so far
    - 1.1 billion + 300 M = 1.8 billion

    - s/n > 7  0.41
        R: [ 0.54473921  0.54615067]
        Rpsf: [ 0.  0.]

        Rsel: [ 0.00834174  0.00838864]
        Rpsf_sel: [ 0.  0.]
        without correction
        errors are 2 sigma
        m: 1.550e-02 +/- 1.302e-03  c: 1.363e-05 +/- 2.604e-05

        with correction
        errors are 2 sigma
        m: 1.846e-04 +/- 1.282e-03  c: 1.343e-05 +/- 2.565e-05
    - s/n > 10 0.27
        R: [ 0.58350906  0.58486481]
        Rpsf: [ 0.  0.]

        Rsel: [ 0.00230262  0.00238869]
        Rpsf_sel: [ 0.  0.]
        without correction
        errors are 2 sigma
        m: 3.358e-03 +/- 1.179e-03  c: 5.394e-08 +/- 2.357e-05

        with correction
        errors are 2 sigma
        m: -5.861e-04 +/- 1.174e-03  c: 5.372e-08 +/- 2.348e-05

    - s/n > 13 0.19

        R: [ 0.60210071  0.60343265]
        Rpsf: [ 0.  0.]

        Rsel: [-0.0007675  -0.00073635]
        Rpsf_sel: [ 0.  0.]
        without correction
        errors are 2 sigma
        m: -1.508e-03 +/- 1.195e-03  c: 1.043e-05 +/- 2.388e-05

        with correction
        errors are 2 sigma
        m: -2.337e-04 +/- 1.197e-03  c: 1.044e-05 +/- 2.391e-05

    - s/n > 16 0.14

        R: [ 0.61185599  0.61321836]
        Rpsf: [ 0.  0.]

        Rsel: [-0.00284776 -0.00277587]
        Rpsf_sel: [ 0.  0.]
        without correction
        errors are 2 sigma
        m: -4.495e-03 +/- 1.269e-03  c: 4.604e-06 +/- 2.535e-05

        with correction
        errors are 2 sigma
        m: 1.603e-04 +/- 1.275e-03  c: 4.624e-06 +/- 2.547e-05

    - s/n > 19 0.10
        R: [ 0.61359044  0.61494467]
        Rpsf: [ 0.  0.]

        Rsel: [-0.00498247 -0.00494711]
        Rpsf_sel: [ 0.  0.]
        without correction
        errors are 2 sigma
        m: -7.980e-03 +/- 1.386e-03  c: -4.470e-06 +/- 2.768e-05

        with correction
        errors are 2 sigma
        m: 1.415e-04 +/- 1.397e-03  c: -4.506e-06 +/- 2.791e-05
